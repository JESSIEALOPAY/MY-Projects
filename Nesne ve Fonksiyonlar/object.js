...
//                      just plesure
// let sayı1 = document.getElementById('num1')
// let sayı2 = document.getElementById('num2')

// document.getElementById('pleasureBtn').addEventListener('click', function (e) {
//     errors.innerHTML = ''
    


//     try {
//         if (isNaN(sayı1.value)) {
//             throw new Error('please type a number')

//         }
//         if (isNaN(sayı2.value)) {
//             return new Error('please type a number')
//         }
